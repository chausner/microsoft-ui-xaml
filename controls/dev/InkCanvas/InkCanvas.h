...
private:
    ...
    // available. A system-backed process splices the ink visual under a lifted MUC visual
    // (AttachToSystemCompositor); a lifted process bridges it into the XAML tree via
